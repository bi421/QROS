-- Atomic research-run creation plus idempotency reservation.
-- The idempotency row and research_run row commit or roll back together.

create or replace function public.create_research_run_idempotent(
