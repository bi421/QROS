...
class RequestMetrics:
    ...
    def prometheus_text(self) -> str:
        ...
        lines = [
            "# HELP qros_jobs_created_total Jobs created.",
            "# TYPE qros_jobs_created_total counter",
            f"qros_jobs_created_total {snapshot['jobs_created_total']}",
            "# HELP qros_jobs_failed_total Jobs failed.",
            "# TYPE qros_jobs_failed_total counter",
            f"qros_jobs_failed_total {snapshot['jobs_failed_total']}",
            "# HELP qros_jobs_duration_seconds Total observed job duration.",
            "# TYPE qros_jobs_duration_seconds counter",
            f"qros_jobs_duration_seconds {snapshot['jobs_duration_seconds']:.6f}",
