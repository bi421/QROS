...
## 10. Contradiction as first-class evidence
...
Robustness → Replication → Supporting + Contradicting Evidence →
Research Search Budget → Missing Evidence → Evidence State →
Knowledge Promotion → Later Reproduction
```
